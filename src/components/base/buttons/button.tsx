...
export const styles = sortCx({
    ...
    colors: {
        ...
        // secondary/tertiary text+icon are brand purple (not the library's
        // default neutral gray) to match xyra-web's Default/Transparent
        // buttons, which show brand purple #533bff at rest - see
        // .sapMBtnTransparent's un-hovered color rule in webapp/css/style.css.
        secondary: {
            root: [
                "bg-primary text-brand-secondary shadow-xs-skeuomorphic ring-1 ring-primary ring-inset hover:bg-brand-secondary hover:text-brand-secondary_hover data-loading:bg-brand-secondary",
                // Icon styles
                "*:data-icon:text-brand-secondary hover:*:data-icon:text-brand-secondary_hover",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-brand-secondary hover:bg-brand-secondary hover:text-brand-secondary_hover data-loading:bg-brand-secondary",
                // Icon styles
                "*:data-icon:text-brand-secondary hover:*:data-icon:text-brand-secondary_hover",
            ].join(" "),
        },
