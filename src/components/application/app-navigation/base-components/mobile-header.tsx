...
export const MobileNavigationHeader = ({ children }: PropsWithChildren) => {
    return (
        <AriaDialogTrigger>
            {/* dark-mode + xyra-sidebar + navy bg to match the sidebar it opens - see sidebar-simple.tsx */}
            <header className="dark-mode xyra-sidebar flex h-14 items-center justify-between border-b border-secondary bg-[#0f172a] p-3 pl-4 lg:hidden">
                <XyraLogoDark className="h-auto w-20" />
